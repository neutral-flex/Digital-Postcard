...
namespace Es.InkPainter.Sample
{
	public class MousePainter : MonoBehaviour
	{
        ...
        {
			brush.brushColor = ColorChooser.col;
			brush.brushScale = ColorChooser.i.sl.value;
			brush.brushNormalBlend = ColorChooser.i.sliderForWater.value;
			brush.brushTexture = ColorChooser.i.a;
		}
